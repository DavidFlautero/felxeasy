// app/admin/layout.tsx (Versi車n simplificada)
...
export default async function AdminLayout({
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      {/* Sidebar - Oculto en m車viles, visible en desktop */}
      <aside className="hidden lg:flex w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex-col">
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-700">
          ...
          {/* Formulario de cierre de sesi車n corregido */}
        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* Bot車n de cerrar sesi車n en m車vil */}
